...
def extrapolate(
    ...
    result['chi2'] = sum((y_mean-(p_mean[0]*x**(-p_mean[1])+p_mean[2]))**2/y_sem**2) / (len(x)-len(p_mean))
    result['mu'],result['sigma'] = np.mean((y_mean-(p_mean[0]*x**(-p_mean[1])+p_mean[2]))/y_sem), np.std((y_mean-(p_mean[0]*x**(-p_mean[1])+p_mean[2]))/y_sem)
