...
def test_aggregate(tmpdir):
    ...
    assert stats.loc[stats['n'] == 100]['acc_val'].values[0] == 0.8  # Check the max 'acc_val' for n=100
    assert stats.loc[stats['n'] == 200]['acc_val'].values[0] == 0.9  # Check the max 'acc_val' for n=200
